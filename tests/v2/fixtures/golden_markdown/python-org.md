...
- url: https://www.python.org/community/
  text: Community
- url: https://www.python.org/#top
  text: ▲The Python Network
- url: https://www.python.org/
  text: ''
- url: https://donate.python.org/
  text: Donate
- url: https://www.python.org/#site-map
  text: ≡Menu
- url: https://www.python.org/
  text: AA
- url: javascript:;
...
- url: http://brochure.getpython.info/
  text: Python Brochure
- url: https://www.python.org/about
  text: Learn more about Python
...
- url: https://www.python.org/ftp/python/3.14.5/Python-3.14.5.tar.xz
  text: Python 3.14.5
- url: https://www.python.org/downloads/
  text: View the full list of downloads
- url: https://www.python.org/ftp/python/pymanager/python-manager-26.2.msix
  text: Python install manager
- url: https://www.python.org/ftp/python/3.14.5/python-3.14.5-amd64.exe
  text: Python 3.14.5
- url: https://www.python.org/downloads/
  text: View the full list of downloads
- url: https://www.python.org/ftp/python/3.14.5/python-3.14.5-macos11.pkg
  text: Python 3.14.5
- url: https://www.python.org/downloads/
  text: View the full list of downloads
- url: https://www.python.org/downloads/operating-systems/
  text: View the full list of downloads
...
- url: https://www.python.org/doc/versions/
  text: Documentation page to browse by version
...
- url: https://www.python.org/psf/annual-report/2024/
  text: PSF Annual Impact Report
- url: https://www.python.org/community/workshops/
  text: Python Conferences
